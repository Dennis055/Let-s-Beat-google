...
font-style:italic;width:523px;height:20px;z-index:2;border:2px solid#FFFFFF;border-radius: 15px;box-shadow:5px 3px 5px 0px rgba(42,42,42,.75);margin:auto;}
input[type="text"]:hover{box-shadow:5px 3px 5px 0px rgba(23,87,214,.75);}
input[type="submit"]{position:absolute;left:70%;top:40%;border-radius:10px;color:#000000;background-color:#FFFFFF;box-shadow:5px 3px 5px 0px rgba(42,42,42,.75);height:25px;width:70px}
